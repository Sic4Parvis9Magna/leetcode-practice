...
public class RemoveElementInPlace {
    public static void main(String[] args) {
        RemoveElementInPlaceSolution sol = new RemoveElementInPlaceSolution();
        int nums[] = {3,2,2,3};
        // int nums[] = {3,3};
        int val = 3;
        int result = sol.removeElement(nums, val);
        int[] cutResult = Arrays.stream(nums).limit(result).toArray(); 
        System.out.println("result is:");
        System.out.println(Arrays.toString(cutResult)); 
    }
}
class RemoveElementInPlaceSolution {
