...
public class LinkedListCycle2 {
    public static void main(String[] args) {
        // TODO improvements
        // embed cycle detection into the algorithm, not as a separate step
        test1();
        test2();
    }
    ...
    private static void test2() {
        ...
        System.out.println("has cycle ? " + sol.hasCycle(l1));
        ListNode res = sol.detectCycle(l1);
        System.out.println("reesult is " + res);
    }
    ...
    private static void test1() {
        ...
        System.out.println(sol.reachedOnlyOnce(l2));
        ListNode res = sol.detectCycle(l1);
        System.out.println("reesult is " + res);
    }
}
