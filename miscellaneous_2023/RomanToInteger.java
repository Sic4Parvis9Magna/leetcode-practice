...
public class RomanToInteger {
    ...
    public static void tests() {
        ...
        tests.add(new Object[] { "III", 3 });
        tests.add(new Object[] { "LVIII", 58 });
        tests.add(new Object[] { "MCMXCIV", 1994 });
        ...
        for (Object[] test : tests) {
            ...
            // When
            int actualResult = sol.romanToInt(s);
...
class Solution {
    ...
    public int romanToInt(String s) {
        ...
        for (int i = 0; i < s.length(); i++) {
            ...
            int valueToAdd = currentValue;
            if (i < s.length() - 1) {
                int nextValue = romanValues.get(s.charAt(i + 1));
                if (nextValue > currentValue) {
                    valueToAdd = nextValue - currentValue;
                    i++;
                }
            }
            result += valueToAdd;
